...
if __name__ == "__main__":
    ...
    for class_name in class_names: # create two matching lists of class directories and labels in a dictionary
        for f in (root / class_name).glob("*.tif"):
            ...
            labels.append(stage_one_idx[class_name])
    ...
    two_stage_model.save(r"\\rivendell.physics.ox.ac.uk\user\students\2024\jesu4837\summer_internship\models\stage_one.keras")
